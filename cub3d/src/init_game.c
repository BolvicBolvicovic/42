...
void	rotate_left(t_game *game, double rotation_angle)
{
	...
	game->dir_pos.y = old_dir_x * sin(rotation_angle) + game->dir_pos.y
		* cos(rotation_angle);
	game->plane_pos.x = game->rc.plane.x * cos(rotation_angle) - game->rc.plane.y
		* sin(rotation_angle);
	game->plane_pos.y = old_plane_x * sin(rotation_angle) + game->rc.plane.y
		* cos(rotation_angle);
}
...
void	rotate_right(t_game *game, double rotation_angle)
{
	...
	game->dir_pos.y = old_dir_x * sin(-rotation_angle) + game->dir_pos.y
		* cos(-rotation_angle);
	game->plane_pos.x = game->rc.plane.x * cos(-rotation_angle)

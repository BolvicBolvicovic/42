...
/*   Updated: 2024/01/25 13:39:25 by vcornill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( ClapTrap &copy ) : name(copy.name), health(copy.health), energy(copy.energy), attackDamage(copy.attackDamage)
{ std::cout << "ClapTrap " << this->name << " created." << std::endl; }
ClapTrap::~ClapTrap()
